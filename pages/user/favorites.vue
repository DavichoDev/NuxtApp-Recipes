<template>
  <v-container>
    <h1 class="secondary--text">
      Favorite recipes
      <v-icon large class="secondary--test">mdi-heart</v-icon>
    </h1>
    <p class="secondary--test">Your favorite recipes</p>
    <v-row>
    ...
    <div class="mt-3">
      <v-alert
        ...
        <p>You do not have favorite recipes... yet :9</p>
      </v-alert>
    </div>
    <div class="mt-3">
    ...
    async asyncData({app, store}) {
        ...
        await client.query(query)
            .then(({data}) => {
                ...
                console.error('Front Error -> favorites - AsyncData: ', error)
            });
        return {
            favorites
        }
